	...
	<body>
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp" method="post">
								...
								<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="HEIGHT: 22px" align="center"
												...
												<s:if test="#o.state==2">买家已付款（<a href="${pageContext.request.contextPath}/adminOrder_sendOrder.action?oid=<s:property value="#o.oid"/>"><font color="blue">发货</font></a>）</s:if>
	        ...
	        <s:if test="pageBean.page !=1">
	            <a href="${pageContext.request.contextPath }/adminOrder_findAllByPage.action?page=1"><font color="blue">首页</font></a>&nbsp;
			    <a href="${pageContext.request.contextPath }/adminOrder_findAllByPage.action?page=<s:property value="pageBean.page-1"/>"><font color="blue">上一页</font></a>&nbsp;
			</s:if>
			<s:else>
			    <span>首页</span>&nbsp;
			    <span>上一页</span>&nbsp;
			...
			<s:if test="pageBean.page !=#p">
			    <a href="${pageContext.request.contextPath }/adminOrder_findAllByPage.action?page=<s:property value="#p"/>"><font color="blue"><s:property value="#p"/></font></a>
			</s:if>
			<s:else>
			...
			<s:if test="pageBean.page !=pageBean.totalPage">
			    <a href="${pageContext.request.contextPath }/adminOrder_findAllByPage.action?page=<s:property value="pageBean.page+1"/>"><font color="blue">下一页</font></a>&nbsp;
			    <a href="${pageContext.request.contextPath }/adminOrder_findAllByPage.action?page=<s:property value="pageBean.totalPage"/>"><font color="blue">尾页</font></a>&nbsp;
			</s:if>
			<s:else>
			    <span>下一页</span>&nbsp;
			    <span>尾页</span>&nbsp;
