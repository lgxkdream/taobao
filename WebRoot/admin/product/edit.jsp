		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_update.action" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td width="30%" class="ta_01" bgColor="#ffffff">
						<input type="text" name="shop_price" value="<s:property value="formatDouble(model.shop_price)" />" id="userAction_save_do_logonName" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						市场价格：
					</td>
					<td width="30%" class="ta_01" bgColor="#ffffff">
						<input type="text" name="market_price" value="<s:property value="formatDouble(model.market_price)" />" id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td width="30%" class="ta_01" bgColor="#ffffff">
					    <textarea rows="3" cols="30" name="pdesc"><s:property value="model.pdesc"/></textarea>
					</td>
				</tr>
