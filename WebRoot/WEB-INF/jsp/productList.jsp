	...
	<div class="pagination">
	     <s:if test="cid != null">
			...
			<s:if test="pageBean.totalPage>5">
			    ...
			    <a href="${pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="cid"/>&page=<s:property value="#p"/>"><s:property value="#p"/></a>
		    	</s:if>
			    <s:else>
	    ...
	    <s:if test="csid != null">
			...
			<s:if test="pageBean.totalPage>5">
			    ...
			    <s:iterator var="p" begin="pageBean.totalPage-4" end="pageBean.totalPage">
		       	<s:if test="pageBean.page !=#p">
			    <a href="${pageContext.request.contextPath }/product_findByCsid.action?csid=<s:property value="csid"/>&page=<s:property value="#p"/>"><s:property value="#p"/></a>
		    	</s:if>
			    <s:else>
			    <span class="currentPage"><s:property value="#p"/></span>
			    </s:else>
